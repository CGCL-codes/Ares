 ...
 */
public class WordCountLatencyBolt extends BaseRichBolt {
    private static Logger logger= LoggerFactory.getLogger(WordCountLatencyBolt.class);
    ...
    public WordCountLatencyBolt(long waitTimeMills) {
